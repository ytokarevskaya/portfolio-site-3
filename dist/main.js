...
// EXTERNAL MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??ruleSet[1].rules[1].use[1]!./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/scss/style.scss
...
/* harmony default export */ const scss_style = ((style_default()).locals || {});
...
const form_form = document.querySelector(".modal__form");
...
function openForm() {
    form_form.classList.add("is-active");
}

function closeForm() {
    form_form.classList.remove("is-active");
}
// CONCATENATED MODULE: ./src/js/scroll.js
;
